...
# Local delta vs plugins/dev-core/tools/license_check.py.
# Do not flatten on vendor sync: compound SPDX, PSF-2.0,
# UNKNOWN bucket. --self-test grafted; policy logic kept.
